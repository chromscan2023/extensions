...
class AddNewPrivateKey extends React.Component<{}, IState> {
  ...
  doImportPrivateKey() {
    ...
    var accountinfo = web3.eth.accounts.privateKeyToAccount(
    ...
    return (
      <div id="popup">
        <div className="container">
          ...
          <div
            className="title"
            style={{ textAlign: "center", position: "relative", top: "5rem" }}
          >
            Import Private key
          </div>
          <div
                  ...
                  <div className="row">
                    <div className="col text-center">
                      <button
                        ...
                        onClick={this.doImportPrivateKey}
                      >
                        Import Private Key
                      </button>
                    </div>
...
export default AddNewPrivateKey;

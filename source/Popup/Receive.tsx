...
class Receive extends React.Component<{}, IState>{
    ...
    constructor(props:any){
      ...
      generateAddressShort(address:string){
        var addressshort=address.substring(0,24)+"....."+address.substring(-1,4);
        return addressshort;
      }
      ...
      noticemessage=<div className="alert alert-success" role="alert">{this.state.message}</div>
       ...
       {/*<div className="col-md-9 col-12 mx-auto d-flex mt-2 mb-4">
        ...
        <div className="col text-center">
          ...
          {noticemessage}
        <div className='spacer' style={{ background: 'white', padding: '16px' }}>
            <QRCode value={this.state.address} onClick={this.copyTextToClipboard} />
            
        </div>
        <div className='spacer'><b onClick={this.copyTextToClipboard}>{this.generateAddressShort(this.state.address)}</b></div>

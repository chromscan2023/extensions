...
class Home extends React.Component<{}, IState> {
  ...
  render() {
    ...
    return (
      <div id="popup" className="app-content">
        <div className="menu-bar">
          <button className="connected-status-indicator">
            <div
              className="color-indicator color-indicator--color-icon-default color-indicator--size-sm"
              data-testid="color-icon-icon-default"
            >
              <span className="color-indicator__inner-circle"></span>
            </div>
            <div className="connected-status-indicator__text">
              Not connected
            </div>
          </button>
            ...
            <div>
              <div title="" className="" style={{ display: "inline" }}>
                <div className="eth-overview__balance">
                  ...
                  <div
                    className="currency-display-component eth-overview__secondary-balance"

...
class SendResult extends React.Component<{}, IState> {
  ...
  async sendCoin() {
    ...
    const signedTx =
      (await web3.eth.accounts.signTransaction(transaction, privateKey)) || "";
  ...
  render() {
    ...
    if (this.state.showtransactionreceipt) {
      showtransactionview = (
        <div>
          Hash:
          <b onClick={this.openWindow} style={{ textDecoration: "underline" }}>
            {"http://testnet.chromescan.org/tx/" + this.state.hash}
          </b>
        </div>
      );
    }
        ...
        <div className="container">
          <div className="row d-flex justify-content-center">
            <div className="col-md-9 col-12 mx-auto d-md-flex justify-content-between mb-4">
              <div className="logo-img-div text-center my-3">
              ...
              <div className="d-flex align-items-center justify-content-center ">
                <div className="d-flex align-items-center">
                  <div className="dropdown active-account">
                    <button
                      className="btn dropdown-toggle d-flex align-items-center grey-text rounded-pill mx-1"
                      type="button"
              ...
              <div className="">
                ...
                <div className="col-12 ">
                  <div className="d-flex align-items-center px-3">
                    <div
                      className="col-12 my-3 d-flex align-items-center metamask-address rounded p-3"
                      style={{

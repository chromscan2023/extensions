...
class Help extends React.Component<{}, IState>{
    ...
    */}
                            ...
                            <div className="btns-div d-flex ">
                                      <button 
                                      className="btn btn-primary my-3 w-100 me-1 hollow-btn py-2 small-btn  rounded-pill" onClick={this.noThanks}>
                                      ...
                                      <button 
                                      className="btn btn-primary my-3 gold-btn w-100 ms-1 py-2 small-btn rounded-pill" onClick={this.goToCreateWallet}>
                              ...
                              <span>
                                  <p className="pb-4">
                                      This data is aggregated and is therefore anonymous for the purposes of General Data Protection Regulation (EU) 2016/679. For more information in relation to our privacy practices, please see our <span className="gold-text"> Privacy policy here. </span>
                                  </p>
                              </span>
